...
#IMPORTANT: setwd changes the working directory. All file references will be relative to this path
setwd("/Users/your_username/directory_that_you_keep_your_GA_work_in")
library(ggplot2)
